/***************************************************************************
  Projeto PreAr
  O projeto PreAr é uma iniciativa de ciência cidadã de sensoriamento participativo sobre dados atmosféricos,
  desenvolvido por Nilton Felipe de Oliveira Braz em parceria com a COOPBRAVO Cooperativa de Trabalho dos Profissionais de Coleta Seletiva e Reaproveitamento de Materiais Reciclaveis do Baixo Acarau
  https://coopbravo.com.br
  ***************************************************************************
  O kit PreAr é composto por um microcontrolador ESP8266 NodeMCU Lolin V3, e dois sensores, o BME280 e o MQ-135.
